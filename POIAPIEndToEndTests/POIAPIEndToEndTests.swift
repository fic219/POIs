...
class POIAPIEndToEndTests: XCTestCase {
    ...
    private let expectedPOIS = [
        POI(name: "Budapest office",
            ...
            imageURL: "http://candidate.mondriaan.com/img/Budapest office.jpg".percentEncodedURL!,
            longitude: 19.034413,
            latitude: 47.529783),
        POI(name: "Future office",
            ...
            imageURL: "http://candidate.mondriaan.com/img/Future office.jpg".percentEncodedURL!,
            longitude: 19.03889,
            latitude: 47.529865),
        POI(name: "Daubner Cukrászda",
            ...
            imageURL: "http://candidate.mondriaan.com/img/Daubner Cukraszda.jpg".percentEncodedURL!,
            longitude: 19.031758,
            latitude: 47.528469),
        POI(name: "Déjá-Vu Étterem",
            ...
            imageURL: "http://candidate.mondriaan.com/img/Deja-Vu Etterem.jpg".percentEncodedURL!,
            longitude: 19.032864,
            latitude: 47.529506),
    ]
